...
<section class="s">
    ...
    <div class="row">
        <form action="services_apply.php">
...
<div class="row">
    <form action="publishes_apply.php">
        <button type="submit" class="hero-btn1 red-btn1">Apply</button>
    </form>
</div>
</section>
...
<div class="row">
    <form action="projects_apply.php">
        <button type="submit" class="hero-btn1 red-btn1">Apply</button>
    </form>
</div>
</section>
...
<section class="servics">
    ...
    <p>There are several services done by the Geo-Tech HUB such as projects related to the national development with some 
        companies such as UDA and Lanka sugar company etc. Collaborative researches are done related to the other faculties 
        as well as other companies. Surveying and mapping services, droner services, training courses and industrial services for 
        students are supplied. Web Based, GIS based services are also supplied and construction programs are conducted by the Geo-Tech Hub.
    </p>  
    
    <div class="row">
        <div class="Specialities-col">
            <h3>3D Modeling</h3>
            <img src="img/project_new/3dmodling.jpg" height="250px" width="300px">
            <ul>
                <li>  Buildings Models </li>
                <li>Statues </li>
                <li>Landscapig Models</li>
                <li>DEM- DTM & DSM, 3D Mesh, TIN  </li>
                <li>Time Series Analysis – Hydro Processing </li>
              </ul>
        </div>

        <div class="Specialities-col">
            <h3>Surveying</h3>
            <img src="img/project_new/surveying.jpeg" height="250px" width="300px">
            <ul>
                <li>	Land Surveying </li>
                <li>	UAV surveying</li>
                <li>	Lidar surveying</li>
                <li>	Ortho-photo  Generation</li>
                <li>Feature Data Extraction   </li>
              </ul>
        </div>

        <div class="Specialities-col">
            <h3>Mapping</h3>
            <img src="img/project_new/mapping.jpeg" height="250px" width="300px">
            <ul>
    ...
    <div class="row">
        <div class="Specialities-col">
            <h3>Planning</h3>
            <img src="img/project_new/planning.jpeg" height="250px" width="300px">
            <ul>
        ...
        <div class="Specialities-col">
            <h3>Development</h3>
            <img src="img/project_new/developmnent.jpeg" height="250px" width="300px">
            <ul>
                <li>Land Administration (Land Administration  <br> Domain Model)</li>
                <li>Land Management Platform Development</li>
                </ul>
        </div>

        <div class="Specialities-col">
            <h3>Research Works</h3>
            <img src="img/project_new/reserch2.jpeg" height="250px" width="300px">
            <ul>
                <li>Data collection</li>
                <li>Data visualizing</li>
